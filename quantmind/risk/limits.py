...
class RiskCode(str, Enum):
    ...
    # 组合级（PortfolioRiskEngine）
    POSITION_CONCENTRATION = "POSITION_CONCENTRATION"  # 单标的集中度超上限
    EXPOSURE_LIMIT = "EXPOSURE_LIMIT"                  # 组合净/总敞口超上限
    STRATEGY_CORRELATION = "STRATEGY_CORRELATION"      # 策略间相关性超上限
    TURBULENCE_EXTREME = "TURBULENCE_EXTREME"          # 市场极端波动（Turbulence）
    # 频率
