...
CS_BASKETS = {
    ...
    # 混市篮子用 code.EXCHANGE 后缀（_split_vt_symbol 原生支持），否则跨市标的被路由到错误交易所静默缺数
    "A股银行": (["601398.SSE", "601939.SSE", "600036.SSE", "601166.SSE", "000001.SZSE"], "SSE"),
    "A股消费": (["600519.SSE", "000858.SZSE", "600887.SSE", "000568.SZSE", "603288.SSE"], "SSE"),
    "A股新能源": (["300750.SZSE", "002594.SZSE", "601012.SSE", "300274.SZSE", "688599.SSE"], "SZSE"),
    "A股半导体": (["688981.SSE", "688012.SSE", "002371.SZSE", "603501.SSE", "688008.SSE"], "SSE"),
}
